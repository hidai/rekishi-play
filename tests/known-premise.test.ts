...
const BASELINE: Record<string, number> = {
  ...
  // ieyasu: 0 件（③＋⑤で章・clue・カードの面まで掃き出し済み。
  ...
  // masako: 0 件（③ A/D型仕分け済み。走った夜は選択肢の label で着せて章のむすびで裏返す型へ、
  // 承久の乱の演説は「きみのひと声」＝読者がいま語った言葉を相手に裏返す型へ）
  // shibusawa: 0 件（⑤で clue-1 の「教科書に載らないほう」を、読者がいま遊んだ夜で着せる形へ）
};
// 帳簿は空＝全7作 0 件（2026-07-28 に棚卸し完了）。以後この表は「新しく生えた1件」だけを持つ。
