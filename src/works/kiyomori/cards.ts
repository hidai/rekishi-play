...
export const CARDS: Record<string, Card> = {
  ...
  'p-shigemori': { type: 'person', ch: 3, tone: 'ai', name: '平重盛', read: 'たいらの しげもり',
    text: '清盛の 長男（母は 時子とは 別＝異母兄）。父と 後白河法皇の 対立を 和らげる 調整役。清盛より 早く 病死し、その 死が 対立の 歯止めを 失わせたと される。' },
  ...
  'p-goshirakawa': { type: 'person', ch: 2, tone: 'gold', name: '後白河法皇', read: 'ごしらかわ ほうおう',
    text: '清盛の 生涯の 好敵手。34年 院政を 敷いた。はじめは 協調、やがて 対立。頼朝に「日本一の 大天狗」と 評された、したたかな 人。' },
  'p-sutoku': { type: 'person', ch: 2, tone: 'gold', name: '崇徳上皇', read: 'すとく じょうこう',
    text: '保元の乱で 清盛らに 敗れ、讃岐に 流された 上皇。後白河の 兄。※恨みを 抱いて 死んだという 怨霊の 話は、後の 世が 作った ものと される。' },
  ...
  'w-jisho': { type: 'word', ch: 5, name: '治承三年の政変', read: 'じしょう さんねんの せいへん',
    text: '1179年、清盛が 兵を 率いて 京を おさえ、反平氏の 貴族の 官職を 奪い、後白河法皇を 鳥羽殿に 幽閉して 院政を 止めた クーデタ。平家の 独裁が 頂点に 達した 出来事。' },
