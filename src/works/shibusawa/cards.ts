...
export const CARDS: Record<string, Card> = {
  ...
  // 終章 7-a で 渡す。C型（つながり）は 赤枠でなく 手帳の 家へ（design/known-premise.md §4）。
  // 粒度に 注意（research §7・煉瓦）: 上敷免製は **かべを 組む 構造用**で、外から 見える
  // 化粧煉瓦は べつの 会社＝「東京駅の 赤い かべ」の 直示を 避ける。粘土は **畑**の 下から 採り、
  // 掘った あとを 田に して 返した（田/畑 は 逆に しない）。
  'w-renga': { type: 'word', ch: 7, tone: 'ai', name: '日本煉瓦製造', read: 'にほんれんが せいぞう',
    text: 'きみが 起こす 手つだいを した 会社の 一つ。<ruby>血洗島<rt>ちあらいじま</rt></ruby>の となり、<ruby>上敷免<rt>じょうしきめん</rt></ruby>の 村に 工場を 置いた。<ruby>畑<rt>はたけ</rt></ruby>の 下から よい 土が 出て、<ruby>利根川<rt>とねがわ</rt></ruby>の <ruby>舟<rt>ふね</rt></ruby>で 東京まで 運べたからだ。<br>ここで 焼かれた <ruby>煉瓦<rt>れんが</rt></ruby>は 何百万個も 運ばれ、<b>1914年に できた <ruby>東京駅<rt>とうきょうえき</rt></ruby>の かべを 組んだ</b>。——外がわを おおう 赤い <ruby>化粧<rt>けしょう</rt></ruby>煉瓦の ほうは、べつの 会社が 焼いた もの。<br>土を ゆずった 家には、<ruby>掘<rt>ほ</rt></ruby>った あとを 田に して 返す 約束だったと 伝えられる。' },
