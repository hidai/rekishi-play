...
export const CARDS: Record<string, Card> = {
  ...
  'p-junchu': { type: 'person', ch: 1, tone: 'ai', name: '尾高惇忠', read: 'おだか じゅんちゅう',
    text: 'きみの <ruby>従兄<rt>いとこ</rt></ruby>で、いちばん はじめの 先生。『<ruby>論語<rt>ろんご</rt></ruby>』を はじめ 学問を 授けた 人で、きみの「<ruby>道徳<rt>どうとく</rt></ruby>」の <ruby>芯<rt>しん</rt></ruby>は ここから 来る。後に 明治政府の <ruby>富岡製糸場<rt>とみおかせいしじょう</rt></ruby>の <ruby>初代場長<rt>しょだいじょうちょう</rt></ruby>に なった。' },
  'p-choshichiro': { type: 'person', ch: 1, tone: 'ai', name: '尾高長七郎', read: 'おだか ちょうしちろう',
    text: 'きみの <ruby>従兄<rt>いとこ</rt></ruby>で、<ruby>剣<rt>けん</rt></ruby>の 使い手。1863年、横浜の 外国人を 焼き討ちする 計画を、命がけで <ruby>止<rt>と</rt></ruby>めた 人。——もし この人が 止めなければ、渋沢栄一という 名は、その 夜に 消えて いたかも しれない。' },
  'p-ichiroemon': { type: 'person', ch: 1, tone: 'ai', name: '渋沢市郎右衛門', read: 'しぶさわ いちろうえもん',
    text: 'きみの 父。<ruby>藍玉<rt>あいだま</rt></ruby>（藍染めの もと）を つくって 売る <ruby>豪農<rt>ごうのう</rt></ruby>。きみは 少年の ころから 父に 連れられ、藍葉の <ruby>買<rt>か</rt></ruby>い付け・<ruby>品定<rt>しなさだ</rt></ruby>めを 覚えた——のちの「<ruby>算盤<rt>そろばん</rt></ruby>」の 力の 素地だ。' },
  ...
  'p-yataro': { type: 'person', ch: 5, tone: 'midori', name: '岩崎弥太郎', read: 'いわさき やたろう',
    text: '<ruby>三菱<rt>みつびし</rt></ruby>を 一代で 築いた 男。<ruby>土佐<rt>とさ</rt></ruby>の 出。きみが「みんなで 株を 出し合う（<ruby>合本<rt>がっぽん</rt></ruby>）」を 説いたのに 対し、この人は「一つの 家が <ruby>独占<rt>どくせん</rt></ruby>して 強く なる」を 選んだ。——ただの 敵では ない。<b>その 独占が、海運で 国の 力を 守った 面も ある</b>。もう 一つの 正解を 生きた 人。' },
};
