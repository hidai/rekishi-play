 ...
 * ★型3（WRITING 13）で hook と重なっていた「横浜」を落とし、二拍めを「焼こうとした相手」＝
 * ちぐはぐさの本体にした。**「将軍」は残す**——一度「家」に置き換えたが、小5・中1のペルソナが
 * 2本とも「顔が浮かばなくなった」「その／その が名前の無いものを指して追えない」と報告した
 * （2026-08-02 eval）。三拍の並置に注釈は差せないので ALLOWED として記録する。
 */
export const RIDDLE =
  '<ruby>外国人<rt>がいこくじん</rt></ruby>を 焼こうと した。その 外国に <ruby>港<rt>みなと</rt></ruby>を ひらいた <ruby>将軍<rt>しょうぐん</rt></ruby>に つかえた。その 将軍を たおした 国の <ruby>役人<rt>やくにん</rt></ruby>に なった。——ぜんぶ、同じ 人だ。<br>なんども <ruby>立場<rt>たちば</rt></ruby>を 変えた この 人が、変えなかった ものは 何だろう？ そして この 人は、<ruby>日本一<rt>にっぽんいち</rt></ruby>の <ruby>金持<rt>かねも</rt></ruby>ちに なれた はずなのに、そう しなかった。なぜ？';
...
export const STRINGS: WorkStrings = {
  ...
  titleHook:
    ...
    // 百姓の言い換えは「田と 畑の ある 家の 子」。藍はここでは出さない——初出の説明が
    // 1-a まで来ないので、ペルソナ2本とも「知らない語で言い換えられた」と報告した。
    '田と <ruby>畑<rt>はたけ</rt></ruby>の ある 家の 子。十七の とき、「<ruby>百姓<rt>ひゃくしょう</rt></ruby>の くせに」と 笑われた。<br>やがて、<ruby>横浜<rt>よこはま</rt></ruby>を 焼く 計画を 立てた。<br>——その 顔が いま、一万円札に なっている。',
