  ...
  chapters: [
    {
      ...
      // ★ 用量の試作（docs/design/engagement.md §10・§11）。この章だけ書き直してある。
      //   第二章以降は従来のままで、同じ子が続けて遊んだときの落差が観察の材料になる。
      //
      //   ★★ 二稿（人間の実プレイで6か所「意味が分からない」）。初稿は字数だけを見て削り、
      //   **因果を削って地の文で埋め直す**という往復をやった。二稿の原則は
      //   **「言葉を減らす」のではなく「言葉が運んでいた仕事を別のチャネルへ移す」**:
      //     ・代官所の理不尽（「はい」以外の答えが無い）→ **選択の結果**で体験させる（1-a）
      //     ・勘当＝縁を切る意味と理由      → **選択の結果**で渡す（1-d）
      //     ・「同じことを考えた」「横浜を焼く」の間接表現 → **言い切る**（字数は増えない）
      //     ・感情                          → **場面ごとの表情**（CloseupCast.expr）
      //   知識の層は 手帳（w-amayogatari）へ出した＝赤枠と「もっと深く」を章から抜いてある。
      scenes: {
        // 「はい」以外の答えが無い＝この章の出発点。地の文で言わず、**選ばせてから返す**。
        '1-a': { place: '<ruby>代官所<rt>だいかんしょ</rt></ruby>——十七の 年',
          closeup: { tone: 'tense',
            cast: [{ face: 'p-eiichi@young', name: '栄一（きみ）', expr: { brow: 'angry', eye: 'narrow', mouth: 'frown' } }] },
          text: `<p>きみの 家は <ruby>藍<rt>あい</rt></ruby>の 家だ。<ruby>藍<rt>あい</rt></ruby>は 布を あおく <ruby>染<rt>そ</rt></ruby>める もと。十四の 年から きみは 一人で 村々を まわり、<ruby>葉<rt>は</rt></ruby>を 見わけて 買いつけて きた。</p>
            <p>十七の とき、<ruby>代官所<rt>だいかんしょ</rt></ruby>に 呼ばれた。村を おさめる 役所だ。父の かわりに 出た きみに、<ruby>役人<rt>やくにん</rt></ruby>が 言った。</p>
            <p class="speak">「五百<ruby>両<rt>りょう</rt></ruby> 出せ。」</p>`,
          q: 'きみは どう 答える？',
          choices: [
            { label: '「はい、お出しします」', to: '1-b', effect: { soroban: 1 },
              hist: { verdict: 'もしもルート', moshimo: true, match: 'もし その場で 引きうけて いたら……',
                body: `<p>五百<ruby>両<rt>りょう</rt></ruby>は 父の 金だ。十七の きみに、その場で 出すと 決める 力は 無い。<b>史実の きみは、持ち帰ると 答えた。</b></p>` } },
            { label: '「持ち帰って 父に 相談します」', to: '1-b', canon: true, effect: { rongo: 1 },
              hist: { verdict: '史実では', match: '<ruby>役人<rt>やくにん</rt></ruby>は 笑った',
                body: `<p class="speak">「<ruby>百姓<rt>ひゃくしょう</rt></ruby>の くせに、返事も できぬのか」</p><p>正しく 答えても、笑われる。ここでは <b>「はい」の ほかに 答えが 無い</b>——それが この 世の しくみだった。</p>`,
        ...
        '1-b': { place: '<ruby>従兄<rt>いとこ</rt></ruby>の 家の 二階',
          ...
          spark: 'え！？ いま 一万円札に なって いる 人の <ruby>出発点<rt>しゅっぱつてん</rt></ruby>が、<b>この 計画</b>だ。',
          onEnter: { card: 'w-amayogatari' },
          next: '1-c' },

        // 帰ってきた男の顔だけ → 次の画面で二人が向き合う（同じ絵を二度出さない）。
        '1-c': { place: '二階——<ruby>決行<rt>けっこう</rt></ruby>の 前',
          closeup: { tone: 'tense',
            cast: [{ face: 'p-choshichiro', name: '尾高長七郎', expr: { brow: 'angry', eye: 'sharp', mouth: 'frown' } }] },
          text: `<p><ruby>京<rt>きょう</rt></ruby>から、その 弟が 帰って きた。<ruby>長七郎<rt>ちょうしちろう</rt></ruby>。<ruby>剣<rt>けん</rt></ruby>の うでは 仲間の 中で いちばんだ。</p>
            <p>京にも、外国人を 追い出そうと 集まった 若者が 大ぜい いた。<b>その 多くが、つかまり、<ruby>斬<rt>き</rt></ruby>られて いた</b>。長七郎は それを 見て きた。</p>
            <p>二階に 積まれた 刀を 見て、長七郎は 言った。</p>
        ...
        '1-c2': { place: '二階——夜どおしの 言い争い',
          ...
          closeup: { tone: 'tense', cast: [
            { face: 'p-choshichiro', name: '尾高長七郎', expr: { brow: 'angry', eye: 'sharp', mouth: 'frown' } },
            { face: 'p-eiichi@young', name: '栄一（きみ）', expr: { brow: 'worried', eye: 'wide', mouth: 'frown' } }] },
          text: `<p class="speak">「どうしても 行くと 言うなら、おれが ここで お前を <ruby>斬<rt>き</rt></ruby>る。」</p>
            ...
            <p>言い争いは 夜どおし 続いた。刀は もう <ruby>蔵<rt>くら</rt></ruby>に ある。仲間は 待って いる。</p>`,
          q: 'きみは どう する？',
          choices: [
            ...
            { label: '<ruby>長七郎<rt>ちょうしちろう</rt></ruby>に したがう。刀を おろす', to: '1-d', canon: true, effect: { rongo: 2 },
              hist: { verdict: '史実では', match: '<ruby>栄一<rt>えいいち</rt></ruby>は 折れ、計画は 消えた',
                body: `<p>言い争いは 夜どおし 続き、<ruby>明<rt>あ</rt></ruby>け方、きみが 折れた。買い集めた 武器は 売りはらわれ、69人は ちりぢりに なる。<b>計画は 消えた。</b></p>` } },
          ] },

        // 「勘当」＝縁を切る、という因果も地の文で説明せず、**読者に願い出させる**。
        // 父の「もう、お前の心は決まっているのだろう」が何を指すかは、その選択が決める。
        '1-d': { place: '<ruby>渋沢<rt>しぶさわ</rt></ruby>の 家——その 冬',
          closeup: { tone: 'solemn',
            cast: [{ face: 'p-ichiroemon', name: '父・市郎右衛門', expr: { brow: 'worried', eye: 'closed', mouth: 'flat' } }] },
          text: `<p>計画は やめた。だが、村に いる ことも できない。外国人を おそう ことは、その 外国人を 招き入れた <ruby>幕府<rt>ばくふ</rt></ruby>に <ruby>弓<rt>ゆみ</rt></ruby>を 引く のと 同じだ。役人は もう、刀の 話を かぎつけて いた。</p>
            <p>きみは 父の 前に すわった。</p>`,
          q: '父に、何と 言う？',
          choices: [
            { label: '「しばらく 家を あけます」', to: '1-e', effect: { soroban: 1 },
              hist: { verdict: 'もしもルート', moshimo: true, match: 'もし 家に つながった まま 出て いたら……',
                body: `<p>きみが つかまれば、<ruby>役人<rt>やくにん</rt></ruby>は この 家に 来る。父も 母も ただでは すまない。<b>史実の きみは、<ruby>縁<rt>えん</rt></ruby>を 切って くれと 願い出た。</b></p>` } },
            { label: '「<ruby>勘当<rt>かんどう</rt></ruby>して ください」', to: '1-e', canon: true, effect: { rongo: 1 },
              hist: { verdict: '史実では', match: '<ruby>栄一<rt>えいいち</rt></ruby>は、<ruby>縁<rt>えん</rt></ruby>を 切って くれと 願い出た',
                body: `<p><ruby>勘当<rt>かんどう</rt></ruby>とは、親子の <ruby>縁<rt>えん</rt></ruby>を 切る こと。<b>切って おけば、きみが つかまっても 家は 巻きこまれない。</b></p><p>父の 答えは こうだった。「出て しまってから、勘当した ことに しよう」。</p>` } },
          ] },

        '1-e': { place: '第1章 むすび',
          monologue: '（……この 家に、もう 帰らない。）',
          closeup: { tone: 'grief', cast: [
            { face: 'p-eiichi@young', name: '栄一（きみ）', expr: { brow: 'stern', eye: 'sharp', mouth: 'flat' } },
            { face: 'p-ichiroemon', name: '父・市郎右衛門', expr: { brow: 'worried', eye: 'gentle', mouth: 'soft' } }] },
          text: `<p>父は 長い あいだ だまって いた。それから 一言。</p>
            <p class="speak">「もう、お前の 心は 決まって いるのだろう。<ruby>好<rt>す</rt></ruby>きに しなさい。」</p>
            <p>その 冬、きみは 刀を いっしょに 買い集めた <ruby>従兄<rt>いとこ</rt></ruby>と 二人で 村を 出た。<ruby>京<rt>きょう</rt></ruby>へ 向かう。</p>`,
    ...
    },
    {
      ...
      scenes: {
        '2-a': { place: '<ruby>京<rt>きょう</rt></ruby>・<ruby>三条<rt>さんじょう</rt></ruby>の <ruby>宿<rt>やど</rt></ruby>',
          ...
          text: `<p>村を 出て、<ruby>京<rt>きょう</rt></ruby>。「外国を 追いはらえ」と さけぶ <ruby>若者<rt>わかもの</rt></ruby>が、この 町には あふれて いた。きみと <ruby>喜作<rt>きさく</rt></ruby>も その 中に まじり、人に 会い、うわさを 集める。年が 明けた。ふところの 金は、もう ない。</p>
    ...
    },
    {
      ...
      lead: 'パリで きみは、外国を 追いはらえと 思って きた 目で それを <ruby>拒<rt>こば</rt></ruby>むのか、それとも <ruby>銀行<rt>ぎんこう</rt></ruby>・会社・<ruby>鉄道<rt>てつどう</rt></ruby>の しくみを 学ぶのか。ふところには、自分の ものでは ない 金が ある。',
      start: '3-a',
    ...
    },
    {
      ...
      scenes: {
        ...
        '4-c': { place: '東京・<ruby>改正掛<rt>かいせいがかり</rt></ruby>の 部屋',
          ...
          spark: 'え！？ 工場は できたのに、そこで <ruby>糸<rt>いと</rt></ruby>を とる 女の 人が 集まらなかった。',
    ...
    {
      id: 5, num: '五', title: '<ruby>舟<rt>ふね</rt></ruby>の うえ', years: '1878ごろ',
      ...
      start: '5-a',
      teaser: '明治の 世で、きみは <ruby>負<rt>ま</rt></ruby>けた <ruby>旧主<rt>きゅうしゅ</rt></ruby>・<ruby>慶喜<rt>よしのぶ</rt></ruby>の ことを 思い出す。',
      scenes: {
        ...
        '5-b': { place: '<ruby>隅田川<rt>すみだがわ</rt></ruby>の <ruby>舟<rt>ふね</rt></ruby>の 上',
          ...
          text: `<p>夏の 夕方。<ruby>向島<rt>むこうじま</rt></ruby>の あたりを、舟が ゆっくり 流れて いく。酒が 出て、<ruby>三味線<rt>しゃみせん</rt></ruby>が 鳴る。岩崎は よく 笑い、そして にこやかな まま、こう 言った。</p>
            <p class="speak">「<ruby>渋沢<rt>しぶさわ</rt></ruby>さん。海の 道は、力を 一つに あつめた 者しか まもれん。外国の 船を 追い返せたのも、それが できたからだ。——あんたと わしが 手を 組めば、船も 金も 思いの ままだ。」</p>
          ...
          choices: [
            ...
            { label: '断る。<ruby>株<rt>かぶ</rt></ruby>を 出し合う「みんなの 会社」で いく', to: '5-c', canon: true, effect: { rongo: 1, gappon: 2 },
              hist: { verdict: '史実では', match: '栄一は 手を 組まず、海の 道で 正面から 競った',
                body: `<p>きみは その 手を 取らなかった。数年 のち、政府と <ruby>三井<rt>みつい</rt></ruby>などの 大<ruby>商人<rt>しょうにん</rt></ruby>も 力を 貸して、おおぜいが <ruby>株<rt>かぶ</rt></ruby>を 出し合う 船会社——<ruby>共同運輸<rt>きょうどううんゆ</rt></ruby>——が 生まれる。<ruby>三菱<rt>みつびし</rt></ruby>と 同じ 海に、同じ <ruby>荷<rt>に</rt></ruby>を 運ぶ 船が 走りはじめた。</p><p>——三菱を 育てたのも 政府、それを くずす 側に ついたのも 政府だ。<b>きみの 側にも、国と 大きな 商家が いた</b>。そして この 争いの 終わり方は、どちらの 勝ちでも なかった。</p><p>（——ただし、いま 見た <ruby>舟<rt>ふね</rt></ruby>の 上の やりとりが どこまで ほんとうかは、この あとで。）</p>`,
        ...
        '5-c': { place: '東京・1926年——およそ50年 あとの きみ',
          ...
          text: `<p>この 場面には、へんな ところが ある。</p>
            <p>広く 知られて いる 話では、きみは 岩崎に <ruby>腹<rt>はら</rt></ruby>を 立て、<ruby>芸者<rt>げいしゃ</rt></ruby>を つれて さっと <ruby>席<rt>せき</rt></ruby>を 立った ことに なって いる。まっぷたつの <ruby>決裂<rt>けつれつ</rt></ruby>だ。——だが、その 場面を 書いた 紙で いま たどれる いちばん 古い ものは、<ruby>舟<rt>ふね</rt></ruby>の 日から 80年 あとの 本だった。</p>
      ...
      scenes: {
        ...
        '6-c': { place: '東京・<ruby>兜町<rt>かぶとちょう</rt></ruby>——きみの <ruby>事務所<rt>じむしょ</rt></ruby>、1907年',
          ...
          deep: { q: 'その 会の 紙は、いま 読めるの？', confidence: '○',
            ...
            cite: '※ この 場面で <b>たしかなのは <ruby>慶喜<rt>よしのぶ</rt></ruby>の 言葉だけ</b>だ。しかも よく 見ると 二重に なって いる——<b>四十年 前に 船の 上で 自分が 言った ことを、年を とった 慶喜が 思い出して 語り、そばの 人が 書きとめた</b>。きみの 問いかけの ほうは、書きとめられて いない。' },
          next: '6-d' },
      ...
      scenes: {
        ...
        '7-c': { place: '東京・<ruby>飛鳥山<rt>あすかやま</rt></ruby>——1930年11月',
          ...
          deep: { q: 'なぜ この 人たちが たのみに 来るの？', confidence: '○',
            ...
            cite: '※ 「病を おして 大臣を たずねた」と 書いて いるのは、<ruby>渋沢<rt>しぶさわ</rt></ruby>を <ruby>顕彰<rt>けんしょう</rt></ruby>する 側が 編んだ 資料集と、その <ruby>年譜<rt>ねんぷ</rt></ruby>だ。当時の 新聞も いっしょに 集められて いる——集めたのは、やはり ほめる 側の 人たちだが。' },
          q: 'のこりの 力を、何に つかう？',
          choices: [
            ...
            { label: '<ruby>筆<rt>ふで</rt></ruby>を とる。自分の 一生を、自分の 手で 書き残す', to: '7-d', effect: { soroban: 1, rongo: 1 },
              hist: { verdict: 'もしもルート', moshimo: true, match: 'もし 最後の 力を、自分の 本に つかって いたら……',
                body: `<p>きっと 読みごたえの ある 一冊に なった だろう。血洗島の 夜も、パリの 銀行も、<ruby>舟<rt>ふね</rt></ruby>の 上も、きみの 筆で 一本に つながる。</p><p>だが それは、この 旅で きみが 七つの 手がかりで <b>はがして きた もの</b>と 同じ 形の 紙だ。まっすぐに ならんだ 一生。都合の わるい ところの 見えない 一生。</p><p>そして そのあいだ、あの きまりは 止まった ままだ。まちを まわる 人たちは、目の 前の 家に 出せる ものを 持たない。<b>史実の きみは、最後の 力を 自分の 本には つかわなかった。</b></p>` } },
          ],
          onEnter: { clue: 'clue-7' } },
        ...
        '7-e': { place: '<ruby>終章<rt>しゅうしょう</rt></ruby> むすび——2024年',
          ...
          text: `<p><ruby>孫<rt>まご</rt></ruby>の <ruby>敬三<rt>けいぞう</rt></ruby>たちの 聞き書きは、まだ 続いて いた。きみが 死ぬと、こんどは 手紙を あつめ、<ruby>帳簿<rt>ちょうぼ</rt></ruby>を あつめ——きみの 一生は、やがて 68<ruby>巻<rt>かん</rt></ruby>の 紙に なる。</p>
            ...
            <p>もとに なったのは 七十さいごろの 写真だ。ただし 札を つくった 側の 説明に よると、もっと 力の ある 顔に 見えるよう、そこから 少し 若く <ruby>描<rt>えが</rt></ruby>き直したという。</p>
            <p>——札の 中の 顔は、この 人の どの 年の 顔でも ない。</p>`,
          deep: { q: 'なぜ 若く <ruby>描<rt>えが</rt></ruby>き直したの？', confidence: '○',
            ...
            cite: '※ この 説明を して いるのは、札を つくった 側と、<ruby>渋沢<rt>しぶさわ</rt></ruby>を <ruby>顕彰<rt>けんしょう</rt></ruby>する 記念館だ。えらんだ 側の 説明で ある ことは、頭の すみに 置いて おきたい。' },
