...
export const TIMELINE: TimelineEntry[] = [
  ...
  { y: '1866', ch: 2, key: true, t: '慶喜 15代<ruby>将軍<rt>しょうぐん</rt></ruby>に→栄一 <ruby>図<rt>はか</rt></ruby>らずも<ruby>幕臣<rt>ばくしん</rt></ruby>', d: '一橋家の 家来だった ため、慶喜の 将軍<ruby>就任<rt>しゅうにん</rt></ruby>と 同時に 幕臣に。本人は よろこばなかったと 語って いる。' },
