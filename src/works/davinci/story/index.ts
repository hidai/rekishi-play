    ...
    },
    {
      ...
      scenes: {
        '4-a': { place: 'ミラノ・<ruby>修道院<rt>しゅうどういん</rt></ruby>の <ruby>食堂<rt>しょくどう</rt></ruby>',
          ...
          text: `<p><ruby>宮廷<rt>きゅうてい</rt></ruby>に 入って 十年あまり。ミラノ<ruby>公<rt>こう</rt></ruby>スフォルツァが、街の <ruby>修道院<rt>しゅうどういん</rt></ruby>を 一族の 大切な 場に 作りかえて いた。その 食堂の 大きな 壁が、きみに まかされる。キリストと 十二人の <ruby>弟子<rt>でし</rt></ruby>が、さいごの 食事を する 場面だ。</p>
