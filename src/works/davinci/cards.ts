...
export const CARDS: Record<string, Card> = {
  ...
  'p-cesare': { type: 'person', ch: 5, tone: 'gold', name: 'チェーザレ・ボルジア', read: 'ちぇーざれ・ぼるじあ',
    text: '<ruby>教皇<rt>きょうこう</rt></ruby>の 子で、ヴァレンティノ<ruby>公<rt>こう</rt></ruby>。マキャヴェッリ『<ruby>君主論<rt>くんしゅろん</rt></ruby>』の モデルに なった、こわいほど 冷たい <ruby>野心家<rt>やしんか</rt></ruby>。1502〜03年、きみは この 男の <ruby>軍事技師<rt>ぐんじぎし</rt></ruby>と して 各地を 回り、真上から 見た イモラの <ruby>精密<rt>せいみつ</rt></ruby>な 地図を 描いた。——平和を 願いながら、この 男の ために 戦の 道具を 作る。きみの 一生 いちばん 暗い 岐路。' },
