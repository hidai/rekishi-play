...
export const CARDS: Record<string, Card> = {
  ...
  'p-francois': { type: 'person', ch: 7, tone: 'gold', name: 'フランソワ1世', read: 'ふらんそわ いっせい',
    text: 'フランス王。1516年、64さいの きみを 招き、「王 づきの <ruby>第一<rt>だいいち</rt></ruby>の 画家・技師・<ruby>建築家<rt>けんちくか</rt></ruby>」の <ruby>位<rt>くらい</rt></ruby>と、アンボワーズの クルー<ruby>館<rt>やかた</rt></ruby>を あたえた。<ruby>才<rt>さい</rt></ruby>を 敬い、ただ そこに いる ことを ゆるした 王。「王の うでの 中で きみが 息を 引きとった」という 名高い <ruby>最期<rt>さいご</rt></ruby>は、じつは あとの 世が 作った 話——王は その 日、別の 城に いた。' },
  ...
  'p-lisa': { type: 'person', ch: 6, tone: 'gold', name: 'リザ・デル・ジョコンド', read: 'りざ・でる・じょこんど',
    text: 'きみが 描いた「モナ・リザ」の モデルと される 女の人。フィレンツェの <ruby>絹商人<rt>きぬしょうにん</rt></ruby>フランチェスコの 妻で、ふつうの <ruby>家<rt>いえ</rt></ruby>の おかみさんだった。「あの ほほえみの 人は だれか」は その後 500年 わからなかったが、2005年、ドイツの <ruby>図書館<rt>としょかん</rt></ruby>で 見つかった 1503年の 走り書き——「レオナルドは いま リザの 顔を 描いている」——で、この 人だと ほぼ 決まった。ありふれた 顔が、世界一 有名な 絵に なった。' },
  ...
  'w-monalisa': { type: 'word', ch: 6, name: 'モナ・リザ', read: 'もな・りざ',
    text: 'きみが 描いた、世界で いちばん 有名な <ruby>肖像画<rt>しょうぞうが</rt></ruby>。「あの ほほえみの 人は だれか」は 500年 わからなかったが、2005年、ドイツの <ruby>図書館<rt>としょかん</rt></ruby>で 見つかった 1503年の 走り書き——「レオナルドは いま リザ・デル・ジョコンドの 顔を 描いている」——で、<ruby>絹商人<rt>きぬしょうにん</rt></ruby>の 妻リザだと ほぼ 決まった。一枚の メモが、長年の なぞを 解いた。',
    photo: MONA_LISA },
