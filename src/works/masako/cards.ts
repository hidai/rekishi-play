...
export const CARDS: Record<string, Card> = {
  ...
  'p-masako': { type: 'person', ch: 1, tone: 'ai', name: '北条政子', read: 'ほうじょう まさこ',
    text: 'きみ 自身。<ruby>伊豆<rt>いず</rt></ruby>の 小さな <ruby>武士<rt>ぶし</rt></ruby>の 家に 生まれ、流されて きた <ruby>源頼朝<rt>みなもとの よりとも</rt></ruby>と 結ばれた。夫の 死の あと 26年、子を <ruby>廃<rt>はい</rt></ruby>し、父を 追い、次の <ruby>将軍<rt>しょうぐん</rt></ruby>に なる 子を 京から 迎えて、<ruby>武士<rt>ぶし</rt></ruby>の 世を 守りつづけた。——ただし、この 人が 書いた 文字は 一枚も 残っていない。' },
  ...
  'p-yoriie': { type: 'person', ch: 3, tone: 'seal', name: '源頼家', read: 'みなもとの よりいえ',
    text: 'きみの 長男、2代目の <ruby>将軍<rt>しょうぐん</rt></ruby>。父の 死の あと、家来 13人の <ruby>合議<rt>ごうぎ</rt></ruby>に 力を おさえられ、1203年に 将軍の 座を 追われて <ruby>修禅寺<rt>しゅぜんじ</rt></ruby>へ。翌年、23さいで 死ぬ。その 死を 幕府の 正史は 一行しか 書かず、京の <ruby>僧<rt>そう</rt></ruby>の 書いた 本は 生々しく 書いている。' },
  'p-sanetomo': { type: 'person', ch: 4, tone: 'seal', name: '源実朝', read: 'みなもとの さねとも',
    text: 'きみの 次男、3代目の <ruby>将軍<rt>しょうぐん</rt></ruby>。<ruby>和歌<rt>わか</rt></ruby>に 打ちこみ、歌集『<ruby>金槐和歌集<rt>きんかいわかしゅう</rt></ruby>』を 残した——<b>自分の 言葉が 残った、ただ 一人の 子</b>。1219年、<ruby>鶴岡八幡宮<rt>つるがおかはちまんぐう</rt></ruby>で <ruby>甥<rt>おい</rt></ruby>の 公暁に 討たれた。' },
  ...
  'p-kaneko': { type: 'person', ch: 5, tone: 'gold', name: '卿二位藤原兼子', read: 'きょうのにい ふじわらの かねこ',
    text: '後鳥羽上皇の <ruby>乳母<rt>めのと</rt></ruby>で、京で いちばん 力の ある 人の 一人。1218年、きみは 京へ のぼって この人と 会い、次の 将軍を だれに するかを 話し合った。——東の <ruby>頂点<rt>ちょうてん</rt></ruby>も、西の <ruby>実力者<rt>じつりょくしゃ</rt></ruby>も、どちらも 女性 だった。' },
