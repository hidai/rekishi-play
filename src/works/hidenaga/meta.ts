...
export const HIDDEN: Hidden = {
  ...
  body: `<p>秀長が あと 10年 生きて いたら、歴史は どう 変わって いた だろう。</p>
      <p>利休は 切腹せずに すんだかも しれない。秀次は 死なずに すんだかも しれない。無謀な 朝鮮出兵は、弟の ひと言で 止まったかも しれない。関ヶ原も、大坂の陣も——。</p>
      <p>もちろん、これは「もしも」。歴史に「if」は ない。<br>でも、ひとりの 補佐役の 存在が どれほど 大きかったかを、この「if」は 教えて くれる。</p>
      <p class="speak" style="margin-top:14px">記録に 残らない 仕事こそ、世界を 静かに 支えて いる。<br>——それが、秀長が きみに 遺した 答えだ。</p>`,
