...
export const CARDS: Record<string, Card> = {
  ...
  'p-sorin':{ type:'person', ch:6, tone:'gold', name:'大友宗麟', read:'おおとも そうりん',
    text:'<ruby>豊後<rt>ぶんご</rt></ruby>（大分）の <ruby>大名<rt>だいみょう</rt></ruby>。<ruby>島津<rt>しまづ</rt></ruby>に <ruby>押<rt>お</rt></ruby>されて <ruby>秀吉<rt>ひでよし</rt></ruby>を たより、<ruby>大坂城<rt>おおさかじょう</rt></ruby>を <ruby>訪<rt>おとず</rt></ruby>れた。その とき <ruby>秀長<rt>ひでなが</rt></ruby>から 有名な 言葉を かけられた。' },
  ...
  'w-ichiya':{ type:'word', ch:2, name:'墨俣一夜城', read:'すのまた いちやじょう',
    text:'「一夜で 城を <ruby>築<rt>きず</rt></ruby>いた」という 有名な 伝説。じつは 確かな 記録が なく、後の 世の 物語かも しれない——それでも、<ruby>段<rt>だん</rt></ruby><ruby>取<rt>ど</rt></ruby>りと <ruby>裏方<rt>うらかた</rt></ruby>の 力を <ruby>象徴<rt>しょうちょう</rt></ruby>する 名場面として 語りつがれる。' },
