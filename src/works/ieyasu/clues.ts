// Clues (CLUES, 7 total, design §1-2). They thread the sub-riddle — "how far can you trust the
// history the WINNERS wrote?" — through one theme: how a 神君 image gets built, layer by layer.
// katsu's clues asked the same of a man's self-told tales (本人談); here the器 turns toward the
// official史書 of the side that won (design §0-3). Hand-managed.
...
export const CLUES: Record<string, Clue> = {
  ...
  'clue-5': { ch: 5, text: '「<ruby>劇的<rt>げきてき</rt></ruby>な <ruby>大逆転<rt>だいぎゃくてん</rt></ruby>」ほど 語りたくなる。だが この <ruby>裏切<rt>うらぎ</rt></ruby>りが いつ 決まったかは、いまも <ruby>学者<rt>がくしゃ</rt></ruby>どうしが <ruby>議論<rt>ぎろん</rt></ruby>して いる。<b><ruby>決着<rt>けっちゃく</rt></ruby>して いない、と 知る ことも 一つの 答え</b>。' },
  'clue-6': { ch: 6, text: '<ruby>鐘<rt>かね</rt></ruby>の <ruby>文字<rt>もじ</rt></ruby>は「言いがかり」か、それとも ほんとうの <ruby>非礼<rt>ひれい</rt></ruby>か。<ruby>記録<rt>きろく</rt></ruby>は やりとりを 残すが、<b><ruby>心<rt>こころ</rt></ruby>の 中までは 残さない</b>。わからない ことは、わからない まま 手に 持って おく。' },
  'clue-7': { ch: 7, text: '「<ruby>神君<rt>しんくん</rt></ruby>」の <ruby>話<rt>はなし</rt></ruby>は、<ruby>勝<rt>か</rt></ruby>った 側が 250年 かけて <ruby>積<rt>つ</rt></ruby>み上げた。だが、150年 ちかく つづいた <ruby>戦<rt>いくさ</rt></ruby>の 世が この 男で 終わったのは <ruby>事実<rt>じじつ</rt></ruby>。<b>盛りを 割り引いて なお 残る もの</b>——それを 確かめるのが、なりきりの ねうちだ。' },
};
