  ...
  chapters: [
    {
      ...
      scenes: {
        '1-a': { place: '江戸・本所',
          ...
          text: `<p>きみは <ruby>勝麟太郎<rt>かつ りんたろう</rt></ruby>、のちの <ruby>海舟<rt>かいしゅう</rt></ruby>。<ruby>将軍<rt>しょうぐん</rt></ruby>に お<ruby>目見<rt>めみ</rt></ruby>えできる <ruby>家<rt>いえ</rt></ruby>がらだ。だが <ruby>幕府<rt>ばくふ</rt></ruby>（<ruby>将軍<rt>しょうぐん</rt></ruby>の <ruby>政府<rt>せいふ</rt></ruby>）に つかえる <ruby>家<rt>いえ</rt></ruby>は 数えきれない ほど あり、もらえる <ruby>米<rt>こめ</rt></ruby>は <ruby>家<rt>いえ</rt></ruby>ごとに <ruby>天<rt>てん</rt></ruby>と <ruby>地<rt>ち</rt></ruby>。<ruby>勝<rt>かつ</rt></ruby>の <ruby>家<rt>いえ</rt></ruby>は その いちばん <ruby>下<rt>した</rt></ruby>、つとめる <ruby>役<rt>やく</rt></ruby>も なく、<ruby>暮<rt>く</rt></ruby>らしは かつかつだった。</p>
    ...
    },
    {
      ...
      scenes: {
        '3-a': { place: '<ruby>品川<rt>しながわ</rt></ruby>、世界へ',
          ...
          text: `<p>1860年、冬。<ruby>品川<rt>しながわ</rt></ruby>の 沖から、一そうの 軍艦が 出て いく。<ruby>咸臨丸<rt>かんりんまる</rt></ruby>——日本人の 手で 太平洋を わたり、アメリカへ 向かう 船だ。国どうしの <ruby>約束<rt>やくそく</rt></ruby>を とどける 使いに ついて いく 旅だ。きみ（海舟）は、その 船の <ruby>指揮<rt>しき</rt></ruby>を まかされて 乗りこんだ。</p>
            <p>ゆく手は、冬の <ruby>荒海<rt>あらうみ</rt></ruby>。船は 木の葉のように ゆれ、いつ しずんでも おかしくない。この 海を 知る 日本人は、乗組の 中で ただ 一人——<face pid="p-manjiro"><ruby>中浜万次郎<rt>なかはま まんじろう</rt></ruby></face>。漁に 出て 流され、アメリカで 学んで 帰った 男だ。きみは、その 横顔に たずねた。「わたれるか、この 海は」</p>
            <p class="speak">「海は、こわがる ほど 大きい。だが、わたれない 海では ない」</p>
            <p>万次郎は 海を 見た まま、そう 答えた——気が した。</p>`,
          onEnter: { cards: ['w-kanrinmaru', 'p-manjiro'] },
          next: '3-b' },

        '3-b': { place: '日本人の 船で、わたるか',
          text: `<p>その 使いは、アメリカの 大きな 軍艦・ポーハタン号に 乗って いく。<ruby>咸臨丸<rt>かんりんまる</rt></ruby>は、それに ついて いく ための、いわば おまけの 船だ。日本人だけで 冬の 太平洋を こえた 例は、まだ 一度も ない。</p>
          ...
          choices: [
            { label: 'ポーハタン号に まかせ、無理は しない', to: '3-c', effect: { suji: 1 },
              hist: { verdict: 'もしもルート', moshimo: true, match: 'もし おまけの 船に 乗らなかったら……',
                body: `<p>無理を せず、大きな ポーハタン号に すべて まかせて いても、使いの 用は 足りた。かしこい えらび方だ。</p><p>——だが「日本人が 自分の 船で 太平洋を わたった」という 出来事は 生まれず、海舟の 名も、これほど 世に 出なかったかも しれない。<ruby>史実<rt>じじつ</rt></ruby>の 海舟は、あえて おまけの 船に 乗り、荒海へ こぎ出した。</p>` } },
            { label: '日本人の 船・咸臨丸でも、わたると 手を 挙げる', to: '3-c', canon: true, effect: { sekai: 2 },
              hist: { verdict: '史実では', match: '<ruby>幕府<rt>ばくふ</rt></ruby>の 船は、初めて 太平洋を わたりきる',
                body: `<p><ruby>咸臨丸<rt>かんりんまる</rt></ruby>は およそ 37日 かけて、嵐の 太平洋を こえ、サンフランシスコに ついた。<ruby>幕府<rt>ばくふ</rt></ruby>の <ruby>軍艦<rt>ぐんかん</rt></ruby>が 太平洋を わたりきったのは、これが 初めてだ。「<ruby>自分<rt>じぶん</rt></ruby>たちの 力だけで わたった」——その 評判は 一気に 広まり、海舟の 名を 高めた。</p><p>……ただし、その「自分たちの 力だけで」という ことばには、あとで 確かめる べき 話が つづく。</p>`,
        ...
        '3-c': { place: '船底で、ゆれながら',
          ...
          text: `<p>船が サンフランシスコに 近づく ころ、きみ（海舟）は、ほとんど 船室から 出られずに いた。ひどい <ruby>船酔<rt>ふなよ</rt></ruby>いだ。あれ狂う 海で、じっさいに 船を もたせて いたのは、アメリカ海軍の <face pid="p-brooke">ブルック</face><ruby>大尉<rt>たいい</rt></ruby>たちだった。日本の 海で 自分の 船を なくし、国へ 帰る ために この 船へ 乗せて もらった 男たちだ。船の うごかし方を いちばん 知って いたのは、この 客たちだった。</p>
        ...
        '3-c2': { place: 'サンフランシスコの <ruby>港<rt>みなと</rt></ruby>',
          closeup: { tone: 'warm', cast: [
            { face: 'p-katsu@prime', name: '海舟（きみ）', expr: { brow: 'worried', eye: 'narrow', mouth: 'flat' } },
            { face: 'p-brooke', name: 'ブルック', expr: { brow: 'calm', eye: 'gentle', mouth: 'soft' } } ] },
          text: `<p>ブルックたちは、ここで <ruby>咸臨丸<rt>かんりんまる</rt></ruby>を おりた。アメリカは、この 男たちの 国だ。乗って いく <ruby>理由<rt>りゆう</rt></ruby>は、もう ない。</p>
            <p>ブルックが 乗る べつの 船が 出る 日、<ruby>咸臨丸<rt>かんりんまる</rt></ruby>の <ruby>士官<rt>しかん</rt></ruby>たちは 港へ かけつけた。きみも 走った。</p>
            <p class="speak">「この 先の 海は、あなたがたの 海です」</p>
            <p>ブルックは そう 言って、<ruby>甲板<rt>かんぱん</rt></ruby>から 手を あげた。<ruby>嵐<rt>あらし</rt></ruby>の あいだ、船を もたせて いたのは その 手だ。——その 手が はたらく ところを、きみは 一度も 見て いない。<ruby>船室<rt>せんしつ</rt></ruby>で <ruby>寝<rt>ね</rt></ruby>こんで いたからだ。きみは、船が 小さく なるまで 見つめた。</p>`,
          deep: { q: 'この 日の ことは、どこまで わかって いる？',
            body: `ブルックが アメリカの 船で 帰って いく 日、<ruby>咸臨丸<rt>かんりんまる</rt></ruby>の <ruby>士官<rt>しかん</rt></ruby>たちは 呼びよせられ、船まで 行って こえを そろえて 見送った——そう <ruby>伝<rt>つた</rt></ruby>える <ruby>記録<rt>きろく</rt></ruby>が ある。<br>ただし、その 中に <ruby>海舟<rt>かいしゅう</rt></ruby>が いたか どうかは、はっきり しない。かわした ことばも 残って いない。この 画面の 見送りは、その 記録に のせた <b>想像</b>だ。だから △（<ruby>説<rt>せつ</rt></ruby>が わかれる）。<b>記録を 書いた 人の 目に 入った ものだけが、いまに とどく。</b>`,
            confidence: '△' },
          next: '3-d' },

        '3-d': { place: '第3章 むすび',
          onEnter: { clues: ['clue-3'] },
          text: `<p><ruby>手柄<rt>てがら</rt></ruby>話は、年月と ともに 大きく ふくらんだ。海舟の 話の 中の アメリカ人は、いつも 小さかった。胸を はって 言うのは いつも、「日本人だけで わたった」。</p>
            <p>でも——あの 小さな 船で、冬の 太平洋を こえた。<ruby>船酔<rt>ふなよ</rt></ruby>いで 青い 顔を して いても、きみは、世界の 大きさを この 目で 見た。<b>自慢は 大きくても、この 一歩は 本物だ。</b></p>`,
