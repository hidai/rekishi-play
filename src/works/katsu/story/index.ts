          ...
          choices: [
            { label: '<ruby>剣<rt>けん</rt></ruby>の 腕で、<ruby>武士<rt>ぶし</rt></ruby>として 名を 上げる', to: '1-c', effect: { kimo: 1 },
              hist: { verdict: 'もしもルート', moshimo: true, match: 'もし <ruby>剣<rt>けん</rt></ruby>ひとすじで 生きて いたら……',
                body: `<p><ruby>剣<rt>けん</rt></ruby>の 腕は 本物だ。その 道で 名を 上げる 生き方も、たしかに あった。</p><p>——だが まもなく、<ruby>黒船<rt>くろふね</rt></ruby>が 来る。<ruby>刀<rt>かたな</rt></ruby>では 蒸気の 軍艦に とどかない。剣 ひとすじなら、きみは 新しい 世に 取り残されて いたかも しれない。<ruby>史実<rt>じじつ</rt></ruby>の 海舟は 剣を おさめ、<ruby>蘭学<rt>らんがく</rt></ruby>に 将来を 賭けた。</p>` } },
    ...
    },
    {
      ...
      scenes: {
        '2-a': { place: '<ruby>長崎<rt>ながさき</rt></ruby>・<ruby>出島<rt>でじま</rt></ruby>',
          ...
          spark: 'え！？「<ruby>黒船<rt>くろふね</rt></ruby>を <ruby>見<rt>み</rt></ruby>て すぐ <ruby>海防<rt>かいぼう</rt></ruby>を <ruby>説<rt>と</rt></ruby>いたのは この おれだ」——<ruby>海舟<rt>かいしゅう</rt></ruby>は そう <ruby>語<rt>かた</rt></ruby>る。でも、あの とき <ruby>意見書<rt>いけんしょ</rt></ruby>を <ruby>出<rt>だ</rt></ruby>した <ruby>者<rt>もの</rt></ruby>は、じつは <ruby>大勢<rt>おおぜい</rt></ruby> いた？',
    ...
    },
    {
      ...
      scenes: {
        ...
        '4-c': { place: '<ruby>斬<rt>き</rt></ruby>りに <ruby>来<rt>き</rt></ruby>た <ruby>男<rt>おとこ</rt></ruby>',
          ...
          spark: 'え！？ こんなに <ruby>劇的<rt>げきてき</rt></ruby>な <ruby>出会<rt>であ</rt></ruby>い、ほんとうに あった 話？ ——じつは、その<ruby>場<rt>ば</rt></ruby>を <ruby>見<rt>み</rt></ruby>た <ruby>者<rt>もの</rt></ruby>は だれも いない。<ruby>語<rt>かた</rt></ruby>って いるのは、<ruby>海舟<rt>かいしゅう</rt></ruby> <ruby>一人<rt>ひとり</rt></ruby>きり だ。',
    ...
    },
    {
      ...
      scenes: {
        ...
        '7-b': { place: '<ruby>語<rt>かた</rt></ruby>り<ruby>残<rt>のこ</rt></ruby>した 一生',
          text: `<p><ruby>晩年<rt>ばんねん</rt></ruby>の きみは、<ruby>自分<rt>じぶん</rt></ruby>の 一生を たっぷりと <ruby>語<rt>かた</rt></ruby>った。<ruby>度胸<rt>どきょう</rt></ruby>の <ruby>話<rt>はなし</rt></ruby>、かけひきの <ruby>話<rt>はなし</rt></ruby>——その <ruby>談話<rt>だんわ</rt></ruby>は、のちに『<ruby>氷川清話<rt>ひかわ せいわ</rt></ruby>』という <ruby>本<rt>ほん</rt></ruby>に なって、いまも <ruby>読<rt>よ</rt></ruby>まれて いる。</p>
            <p>だが、この <ruby>本<rt>ほん</rt></ruby>には ふしぎな ところが ある。じつは、<ruby>海舟<rt>かいしゅう</rt></ruby> <ruby>自身<rt>じしん</rt></ruby>が <ruby>書<rt>か</rt></ruby>いた <ruby>本<rt>ほん</rt></ruby>では ない。そして、<ruby>同<rt>おな</rt></ruby>じ <ruby>話<rt>はなし</rt></ruby>が、<ruby>本<rt>ほん</rt></ruby>に よって 少し <ruby>違<rt>ちが</rt></ruby>うのだ。</p>`,
          spark: 'え！？ <ruby>海舟<rt>かいしゅう</rt></ruby>の <ruby>名<rt>な</rt></ruby>ゼリフが たくさん <ruby>載<rt>の</rt></ruby>った『<ruby>氷川清話<rt>ひかわ せいわ</rt></ruby>』——じつは <ruby>海舟<rt>かいしゅう</rt></ruby>が <ruby>書<rt>か</rt></ruby>いた <ruby>本<rt>ほん</rt></ruby>では なく、しかも <ruby>中身<rt>なかみ</rt></ruby>が あとから <ruby>書<rt>か</rt></ruby>きかえられて いた？',
